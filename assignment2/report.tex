...
\item t = 0.00001, k = 0.04
\item t = 0.001, k = 0.15
\item t = 0.0001, k = 0.15
\item t = 0.00001, k = 0.15
\item t = 0.001, k = 0.4
\item t = 0.0001, k = 0.4
\item t = 0.00001, k = 0.4
\end{itemize}
Out of these, we experienced that the value pair giving the best results were $t = 0.001$, $k = 0.15$. The values for $k$ has been chosen based on the recommended values from the slides and the original paper about the detector. The detection points found using the "best" value pair are shown on top of the images in figure \ref{fig:points1}-\ref{fig:points3}. \\\\
...
A lot of the detected corners are correctly detected, but there are also a lot of false corners caused by texture patterns such as the roofs, se for example the edge of the light roof approximately in the middle of the images.

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{output/interest_points1.png}
\caption{Interest points detected with the implemented Harris corner detector for image \textit{Img001\_diffuse\_smallgray.png}. Parameters used for the detection was $\sigma = 1$, square kernelsize $sz = 25$, threshold $t = 0.001$ and $k = 0.15$.}
\label{fig:points1}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{output/interest_points2.png}
\caption{Interest points detected with the implemented Harris corner detector for image \textit{Img002\_diffuse\_smallgray.png}. Parameters used for the detection was $\sigma = 1$, square kernelsize $sz = 25$, threshold $t = 0.001$ and $k = 0.15$.}
\label{fig:points2}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{output/interest_points3.png}
\caption{Interest points detected with the implemented Harris corner detector for image \textit{Img003\_diffuse\_smallgray.png}. Parameters used for the detection was $\sigma = 1$, square kernelsize $sz = 25$, threshold $t = 0.001$ and $k = 0.15$.}
\label{fig:points3}
\end{figure}
...
\begin{subfigure}[b]{1\textwidth}
	...
	\caption{Matches using a descriptor field of width and height 5.}
	\label{fig:N5}
\end{subfigure}\\
\begin{subfigure}[b]{1\textwidth}
	\includegraphics[width=\textwidth]{output/matches7.png}
	\caption{Matches using a descriptor field of width and height 7.}
	\label{fig:N7}
\end{subfigure}\\
...
\begin{subfigure}[b]{1\textwidth}
	...
	\caption{Matches using a descriptor field of width and height 9.}
	\label{fig:N9}
\end{subfigure}\\
\begin{subfigure}[b]{1\textwidth}
	\includegraphics[width=\textwidth]{output/matches13.png}
	\caption{Matches using a descriptor field of width and height 13.}
	\label{fig:N13}
\end{subfigure}
\caption{Matches found in the used test images. The parameters for the corner detection was as for figure \ref{fig:points1} - \ref{fig:points3}.}
\label{fig:matches}
\end{figure}
...
\textbf{Statistics}\\
In table \ref{tab:stats} we see the statistics of our matching. We made 176144 comparisons in total, and we had 389 and 438 interest points in image 1 and 2 respectively. We can see that the first filtering we do reduced the number of possible correspondences significantly. \\\\
...
\begin{table}[H]
	...
	\begin{tabular}{c||c|c|c|c}
		...
		Number of interest points, image 1 & 202 & 202 & 202 & 202 \\ \hline
		Number of interest points, image 2 & 218 & 218 & 218 & 218 \\ \hline
		Number of correspondences after filtering, image 1 & 26 & 24 & 26 & 34 \\\hline
		Number of correspondences after filtering, image 2 & 24 & 22 & 26 & 29 \\\hline
		Number of two-way accepted correspondences& 12 & 13 & 18 & 26 \\ \hline
		Number of correspondences after thresholding & 12 & 13 & 18 & 26 \\ \hline
		Worst possible dissimilarity between patches & 1625625 & 3186225 & 5267025 & 10989225 \\ \hline
		Average dissimilarity & 1877.5 & 5560 & 11256 & 24640 \\ \hline
		Standard deviation & 1751.1 & 5102 & 9752.7 & 19287 \\ \hline
	\end{tabular}
