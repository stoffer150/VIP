...
\begin{homeworkSubProblem}[Method used for calculating disparities]
...
\begin{homeworkSubProblem}[Note on results]
As Søren stated at the lecture the 8th january, several image pairs could be chosen for tests with the tsukuba images, and it is not clear which image pair, the ground truth corresponds to. This might explain the rather big errors we get, but we have not had time to manually check what image pairs corresponds to the ground truth, as Søren suggested.
\end{homeworkSubProblem}
