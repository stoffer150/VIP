...
We spent a lot of time debuggin our code; The most effective ways that we tested our implementation was by using small fragments of pictures and then shifting it a couple of pixels. That way we knew what the expected result should be, and could verify it.\\
...
It is pretty obvoius when looking at the lower level disparities:
\begin{figure}[H]
\centering
\begin{subfigure}[b]{0.24\textwidth}
...
\end{figure}
While this is for kernel size 7, and not 5, it still shows why adding the last scale added quality to the lamp area.
